...
local user_opts = {
    ...
    window_title_color = "#CAD3F5",        -- color of the title in borderless/fullscreen mode
    window_controls_color = "#CAD3F5",     -- color of the window controls (close, minimize, maximize) in borderless/fullscreen mode
    ...
    chapter_title_color = "#CAD3F5",       -- color of the chapter title (above seekbar)
    side_buttons_color = "#CAD3F5",        -- color of the side buttons (audio, subtitles, playlist, etc.)
    middle_buttons_color = "#CAD3F5",      -- color of the middle buttons (skip, jump, chapter, etc.)
    playpause_color = "#CAD3F5",           -- color of the play/pause button
