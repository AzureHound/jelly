...
<h2>This project: jelly</h2>

<br>

The core aim of this project is to co-relate automation and efficiency to extract what is provided to an user on the internet. All content available in the project is hosted by external non-affiliated sources.
